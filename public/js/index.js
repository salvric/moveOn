...
function goAhead() {
    TweenMax.to("#side-left", 0.5, { width: "0%", delay: 1.9 });
    TweenMax.to("#shape", 0.2, { boxShadow: 0, delay: 2.1 });
    TweenMax.to("#layer-01", 0.2, { boxShadow: 0, delay: 2.3 });
    TweenMax.to("#layer-02", 0.2, { boxShadow: 0, delay: 2.5 });
}